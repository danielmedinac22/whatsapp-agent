...
-- dropi_connection 1, agent_settings 1, shopify_connection 0. Son tres filas de
-- configuración, no un histórico: las tablas de datos (1.687 conversaciones,
-- 1.680 pedidos de tienda, 26.179 mensajes) no se tocan.
--
...
-- Los tres UPDATE no tocan "updated_at": la pantalla de Conexiones muestra ese
