 ...
 * la puede escribir. Y como la barra se dibuja en el servidor, después de cada
 ...
 * un id desconocido no se escribe nada y la barra se queda donde estaba.
 *
...
/**
 * Plegar o desplegar la barra. Se recuerda de forma global —no por pantalla—,
 * porque un marco que se pliega solo al navegar es peor que no poder plegarlo.
 */
 ...
 * componente de cliente: el botón de la barra abre una pregunta antes de salir,
 * y un componente de cliente no puede declarar la acción en su propio archivo.
 */
