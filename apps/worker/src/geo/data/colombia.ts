/**
 * Colombia · 32 departamentos más Bogotá D.C., y sus 1.122 municipios.
 *
 * **Fuente: DIVIPOLA**, la división político-administrativa oficial del DANE,
 * publicada en el portal de datos abiertos del Estado
 * (`https://www.datos.gov.co/resource/gdxc-w37w.json`, corte del 30 de
 * diciembre de 2024). El archivo se **generó** de ahí, no se escribió a mano:
 * una lista de mil entradas tecleada de memoria tiene faltantes, y en
 * contraentrega cada faltante es una dirección válida que el sistema rechaza —
 * o sea una venta perdida. Para actualizarla se vuelve a bajar el dataset y se
 * regenera el archivo entero; no se parchea a mano.
 *
 * Los nombres van en el mismo orden y con la misma ortografía de DIVIPOLA,
 * pasados a mayúscula inicial (el dataset los publica en versales). La
 * comparación normaliza tildes, mayúsculas y puntuación
 * (`../country.ts`), así que la ortografía de aquí es de presentación: quien
 * escriba «Narino» o «BOGOTA DC» igual encuentra su municipio.
 *
 * Incluye las 20 «áreas no municipalizadas» de Amazonas, Guainía y Vaupés y las
 * dos islas del archipiélago, que en DIVIPOLA son entradas de pleno derecho.
 * No se filtran: si el Estado las reconoce como destino, no le toca a este
 * archivo decidir que no lo son.
 *
 * **Colombia todavía no opera.** En producción hay una sola operación —
 * Guatemala— y esta lista existe porque la validación es por país y no por una
 * lista fija: es lo que hace demostrable en un test que una dirección
 * colombiana válida falla contra la lista guatemalteca.
 */

import type { AdministrativeDivision } from "../country";

/** Los 33 departamentos de Colombia (32 más Bogotá D.C.), con sus municipios. */
export const COLOMBIA_DIVISIONS: readonly AdministrativeDivision[] = [
  {
    name: "Amazonas",
    cities: [
  ...
  },
  {
    ...
    cities: [
      ...
      "Cocorná", "Concepción", "Concordia", "Copacabana", "Dabeiba",
      "Donmatías", "Ebéjico", "El Bagre", "El Carmen de Viboral",
      ...
      "San Roque", "San Vicente Ferrer", "Santa Bárbara",
      "Santa Fé de Antioquia", "Santa Rosa de Osos", "Santo Domingo",
  ...
  },
  {
    ...
    cities: [
      ...
      "Santa Catalina", "Santa Cruz de Mompox", "Santa Rosa",
  ...
  },
  {
    ...
    cities: [
      ...
      "Tota", "Tunja", "Tununguá", "Turmequé", "Tuta", "Tutazá", "Úmbita",
  ...
  },
  {
    ...
    cities: [
      ...
      "El Cantón del San Pablo", "El Carmen de Atrato",
      "El Litoral del San Juan", "Istmina", "Juradó", "Lloró", "Medio Atrato",
      "Medio Baudó", "Medio San Juan", "Nóvita", "Nuevo Belén de Bajirá",
      "Nuquí", "Quibdó", "Río Iró", "Río Quito", "Riosucio",
  ...
  },
  {
    ...
    cities: [
      ...
      "San Antero", "San Bernardo del Viento", "San Carlos",
  ...
  },
  {
    ...
    cities: [
      ...
      "Guataquí", "Guatavita", "Guayabal de Síquima", "Guayabetal",
      "Gutiérrez", "Jerusalén", "Junín", "La Calera", "La Mesa", "La Palma",
      "La Peña", "La Vega", "Lenguazaque", "Machetá", "Madrid", "Manta",
      "Medina", "Mosquera", "Nariño", "Nemocón", "Nilo", "Nimaima", "Nocaima",
      ...
      "Ubaque", "Une", "Útica", "Venecia", "Vergara", "Vianí",
  ...
  },
  {
    name: "Guainía",
    cities: [
      "Barrancominas", "Cacahual", "Inírida", "La Guadalupe", "Morichal",
  ...
  },
  {
    ...
    cities: [
      ...
      "Santacruz", "Sapuyes", "Taminango", "Tangua", "Túquerres",
      "Yacuanquer",
    ],
  },
  {
    ...
    cities: [
      ...
      "San José de Cúcuta", "Santiago", "Sardinata", "Silos", "Teorama",
  ...
  },
  {
    ...
    cities: [
      ...
      "Charta", "Chima", "Chipatá", "Cimitarra", "Concepción", "Confines",
  ...
  },
  {
    ...
    cities: [
      ...
      "San José de Toluviejo", "San Juan de Betulia", "San Luis de Sincé",
      "San Marcos", "San Onofre", "San Pedro", "Santiago de Tolú",
      "Sincelejo", "Sucre",
    ],
  },
  {
    ...
    cities: [
      ...
      "Rovira", "Saldaña", "San Antonio", "San Luis",
      "San Sebastián de Mariquita", "Santa Isabel", "Suárez",
  ...
  },
  {
    ...
    cities: [
      ...
      "Buenaventura", "Bugalagrande", "Caicedonia", "Calima", "Candelaria",
      ...
      "Restrepo", "Riofrío", "Roldanillo", "San Pedro", "Santiago de Cali",
...
/**
 * Cómo la gente nombra de verdad los municipios cuyo nombre oficial casi nadie
 * usa. Sin esto, «Cartagena» —el nombre que un cliente da por teléfono— no
 * encontraría a «Cartagena de Indias» y la venta se caería en la validación.
 *
 * Solo las variantes que la normalización **no** resuelve sola: quitar tildes,
 * puntos y comas ya hace que «BOGOTA DC» y «Bogotá, D.C.» sean el mismo nombre.
 */
export const COLOMBIA_CITY_ALIASES: Readonly<Record<string, string>> = {
  Bogotá: "Bogotá, D.C.",
...
/** Igual que arriba, para los departamentos. */
export const COLOMBIA_DIVISION_ALIASES: Readonly<Record<string, string>> = {
  Bogotá: "Bogotá, D.C.",
  "Bogotá D.C.": "Bogotá, D.C.",
